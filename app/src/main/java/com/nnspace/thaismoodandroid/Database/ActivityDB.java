...
public class ActivityDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = String.format("CREATE TABLE %s (" +
                        ...
                        "%s DATE NOT NULL " +
                        ");", ActivityModel.TABLE_NAME,
                ActivityModel.column.ID,
                ActivityModel.column.ACTIVITY,
                ActivityModel.column.DATE
        );
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String DROP_FRIEND_TABLE = "DROP TABLE IF EXISTS " + ActivityModel.TABLE_NAME;
