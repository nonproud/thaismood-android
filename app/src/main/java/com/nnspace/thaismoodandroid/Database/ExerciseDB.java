...
public class ExerciseDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = String.format("CREATE TABLE %s (" +
                        ...
                        "%s int NOT NULL," +
                        "%s date NOT NULL" +
                        ");", ExerciseModel.TABLE_NAME,
                ExerciseModel.column.ID,
                ExerciseModel.column.STEP,
                ExerciseModel.column.DATE
        );
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String DROP_FRIEND_TABLE = "DROP TABLE IF EXISTS " + ExerciseModel.TABLE_NAME;
